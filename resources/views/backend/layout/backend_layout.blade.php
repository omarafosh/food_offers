                                            ...
                                            <li class="list-group-item bdw-0" data-role="task">
                                                <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                                                    ...
                                                    <label for="inputCall1"
                                                        class="form-label peers peer-greed js-sb ai-c">
                                            ...
                                            <li class="list-group-item bdw-0" data-role="task">
                                                <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                                                    ...
                                                    <label for="inputCall3"
                                                        ...
                                                        <span class="peer">
                                                            <span class="badge rounded-pill fl-r bg-danger lh-0 p-10">3
                                                                Minutes</span>
                                                        </span>
                                                    </label>
                                                </div>
                                            ...
                                            <li class="list-group-item bdw-0" data-role="task">
                                                <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                                                    ...
                                                    <label for="inputCall5"
                                                        class="form-label peers peer-greed js-sb ai-c">
                                                        <span class="peer peer-greed">Watch Game of Thrones
                                                            Episode</span>
                                                        <span class="peer">
                                                            <span
                                                                class="badge rounded-pill fl-r bg-info lh-0 p-10">Tomorrow</span>
                                                        </span>
                                                    </label>
                                                </div>
                                            </li>
                                            <li class="list-group-item bdw-0" data-role="task">
                                                <div class="checkbox checkbox-circle checkbox-info peers ai-c">
                                                    ...
                                                    <label for="inputCall6"
                                                        ...
                                                        <span class="peer">
                                                            <span
                                                                class="badge rounded-pill fl-r bg-success lh-0 p-10">Done</span>
                                                        </span>
                                                    </label>
                                                </div>
                                            </li>
                                    ...
                                    <div class="layer w-100">
                                        <div class="peers peers-greed ai-fs ta-c">
                                            ...
                                            <div class="peer">
                                                ...
                                                <canvas class="partly-cloudy-day" width="30"
                                                    height="30"></canvas>
